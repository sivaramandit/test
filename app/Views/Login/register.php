...
<div class="row">
<div class="col-md-9">
<form action="<?php echo base_url('register/create'); ?>" name="user_create" id="user_create" method="post" accept-charset="utf-8" enctype= multipart/form-data >
...
<input type="text" name="contact_no" class="form-control" id="contact_no" placeholder="Please enter email id">
</div>   
